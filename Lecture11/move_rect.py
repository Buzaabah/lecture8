...
def main():
    ...
    # animation loop to end.
    """ while True: """
    # animation loop to center of the (0,0) a little left of the center
    """ while get_left_x(canvas, rect) < CANVAS_WIDTH/2: """
    # animation loop in the exact center
